...
const imageSearchLinkStyle: React.CSSProperties = { display: 'block', margin: '10px auto 0', fontSize: '0.95em', fontWeight: 'bold', color: '#fff', background: colors.tertiary, padding: '10px 22px', borderRadius: '50px', border: '2px solid #fff', boxShadow: `0 4px 0 ${colors.tertiaryDark}`, cursor: 'pointer' };
const imageSearchBadgeStyle: React.CSSProperties = { position: 'absolute', bottom: '-9px', right: '-9px', width: '30px', height: '30px', minWidth: '30px', minHeight: '30px', borderRadius: '50%', background: '#fff', border: `2px solid ${colors.tertiaryDark}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1em', boxShadow: shadow.sm, pointerEvents: 'none' };

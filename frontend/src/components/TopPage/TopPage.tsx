...
const genreSelectionContainerStyle: React.CSSProperties = { backgroundColor: colors.surfaceSoft, borderRadius: '30px', padding: '30px', boxShadow: shadow.lg, width: '100%', maxWidth: '700px', boxSizing: 'border-box', animation: 'screenIn 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards' };
...
const difficultySelectionContainerStyle: React.CSSProperties = { backgroundColor: colors.surfaceSoft, borderRadius: '30px', padding: '30px', boxShadow: shadow.lg, width: '100%', maxWidth: '700px', boxSizing: 'border-box', animation: 'screenIn 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards' };
...
const purchasedBadgeStyle: React.CSSProperties = { position: 'absolute', top: '-13px', right: '-8px', background: colors.tertiary, color: '#fff', fontSize: '0.7em', fontWeight: 'bold', padding: '3px 10px', borderRadius: '12px', boxShadow: '0 2px 4px rgba(74,68,88,0.25)', whiteSpace: 'nowrap', border: '2px solid #fff', zIndex: 3 };
const detailIconButtonStyle: React.CSSProperties = { position: 'absolute', top: '-13px', left: '-8px', width: '32px', height: '32px', minWidth: '32px', minHeight: '32px', borderRadius: '50%', background: '#fff', border: `2px solid ${colors.tertiaryDark}`, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 2px 4px rgba(74,68,88,0.25)', zIndex: 3, padding: 0 };
